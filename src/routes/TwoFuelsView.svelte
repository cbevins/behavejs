<script>
    ...
    import { wfmsConfigTable } from '$lib/snippets/WfmsConfigTable.svelte'
    import { wfmsNodeTable } from '$lib/snippets/WfmsNodeTable.svelte'
    let { wfms } = $props()   // Array of nested TreeNode instances
</script>
