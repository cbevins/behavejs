...
const results = {   // array value are for fuel keys ['10', '124']
  axis: {
...
export const FireEllipseBp6Results = [
  [e + 'head.spreadRate',
  ...
  [e + 'head.mapDistance',
    {
      fm010: 1113.1008195269301 / mapScale,
      fm124: 2908.2255596394334 / mapScale,
      prec: 10
    }
  ],
  [e + 'head.scorchHeight',
  ...
  [e + 'back.mapDistance',
    { fm010: 23.671589425163184 / mapScale, fm124: 61.846823840041452 / mapScale, prec: 10 }
  ],
  [e + 'back.scorchHeight',
  ...
  [e + 'flank.mapDistance',
    { fm010: 162.32333654978328 / mapScale, fm124: 424.10436672371793 / mapScale, prec: 9 }
  ],
  ...
  [e + 'beta.spreadDistance',
    { fm010: elapsed * 2.6256648650882601, fm124: elapsed * 6.8494531181657319, prec: 9 }
  ],
  [e + 'beta.mapDistance',
    { fm010: (elapsed * 2.6256648650882601) / mapScale, fm124: (elapsed * 6.8494531181657319) / mapScale, prec: 9 }
  ],
  [e + 'beta.scorchHeight',
  ...
  [e + 'psi.spreadDistance',
    { fm010: elapsed * 13.8977795836636, fm124: elapsed * 36.2892704981354, prec: 9 }
  ],
  [e + 'psi.mapDistance',
    { fm010: (elapsed * 13.8977795836636) / mapScale, fm124: (elapsed * 36.2892704981354) / mapScale, prec: 8 }
  ],
  [e + 'psi.scorchHeight',
  ...
  [e + 'vector.fromHead',
    { fm010: 360 - 42.573367385837855, fm124: 360 - 42.613728665173383, prec: 10 }
  ],
  [e + 'size.area',
    { fm010: 289850.691417, fm124: 45.422576205218135 * (66.0 * 660.0), prec: 6 }
  ],
  [e + 'size.length',
  ...
  [e + 'map.area',
    { fm010: 289850.691417 / m2, fm124: (45.422576205218135 * (66 * 660)) / m2, prec: 6 }
  ],
  [e + 'map.length',
...
export function fireEllipseResults (resultKey) {
  const ar = []
  FireEllipseBp6Results.forEach(result => {
...
export function fireEllipseSelections () {
  return FireEllipseBp6Results.map(result => result[0])
}
