...
test('Compass.compassSlopeRatioMap(mapScale, contourInterval, contours, mapDistance) error handling', () => {
  expect(Compass.compassSlopeRatioMap(0, 1, 1, 1)).toEqual(0)
  expect(Compass.compassSlopeRatioMap(1, 0, 1, 1)).toEqual(0)
  expect(Compass.compassSlopeRatioMap(1, 1, 0, 1)).toEqual(0)
  expect(Compass.compassSlopeRatioMap(1, 1, 1, 0)).toEqual(0)

  expect(Compass.compassSlopeRatioMap(-1, 1, 1, 1)).toEqual(0)
  expect(Compass.compassSlopeRatioMap(1, -1, 1, 1)).toEqual(0)
  expect(Compass.compassSlopeRatioMap(1, 1, -1, 1)).toEqual(0)
  expect(Compass.compassSlopeRatioMap(1, 1, 1, -1)).toEqual(0)
})
