    ...
    constructor(path, mois1h, mois10h, mois100h, moisHerb, moisStem, curedFraction) {
        ...
        this.nodes = [
            ...
            [path+P.stdDeadHeat, 0, U.fuelHeat, 0, [
                [this.any, Cat.standardHeatDead, [path+P.stdKey]],
            ]],
            [path+P.stdLiveHeat, 0, U.fuelHeat, 0, [
                [this.any, Cat.standardHeatLive, [path+P.stdKey]],
            ]],
            // common to all particles (path+P.stdKey arg is ignored)
            [path+P.stdDens, 0, U.fuelDens, 0, [
                [this.any, Cat.standardDens, [path+P.stdKey]],
            ]],
            [path+P.stdSeff, 0, U.fuelSeff, 0, [
                [this.any, Cat.standardSeff, [path+P.stdKey]],
            ]],
            [path+P.stdStot, 0, U.fuelStot, 0, [
                [this.any, Cat.standardStot, [path+P.stdKey]],
            ]],
            // 1-h dead
            ...
            [path+P.stdDead1Type, Cat.standardType1(), U.fuelType, 0, [
            ...
            [path+P.stdDead10Savr, 1, U.fuelSavr, 0, [
                [this.any, Cat.standardSavr10, []],
            ]],
            [path+P.stdDead10Type, Cat.standardType10(), U.fuelType, 0, [
                [this.any, Dag.constant, []],
            ]],
            // 100-h dead
            ...
            [path+P.stdDead100Savr, 1, U.fuelSavr, 0, [
                [this.any, Cat.standardSavr100, []],
            ]],
            [path+P.stdDead100Type, Cat.standardType100(), U.fuelType, 0, [
                [this.any, Dag.constant, []],
            ]],
            // cured portion of total herb load
            [path+P.stdDeadHerbLoad, 0, U.fuelLoad, 0, [
                [this.any, Cat.standardLoadCured, [path+P.stdKey, curedFraction]],
            ]],
            ...
            [path+P.stdDeadHerbType, Cat.standardTypeCured(), U.fuelType, 0, [
                [this.any, Dag.constant, []],
            ]],
            // uncured portion of total herb load
            [path+P.stdLiveHerbLoad, 0, U.fuelLoad, 0, [
                [this.any, Cat.standardLoadUncured, [path+P.stdKey, curedFraction]],
            ]],
            ...
            [path+P.stdLiveHerbType, Cat.standardTypeUncured(), U.fuelType, 0, [
                [this.any, Dag.constant, []],
            ]],
            ...
            [path+P.stdTotalHerbType, Cat.standardTypeHerb(), U.fuelType, 0, [
                [this.any, Dag.constant, []],
            ]],
            // live stem
            ...
            [path+P.stdLiveStemType, Cat.standardTypeStem(), U.fuelType, 0, [
                [this.any, Dag.constant, []],
            ]],
        ]
    }
