...
export class WfmsFireEllipse extends WfmsUseCases {
    ...
    selectFireEllipseTestNodes() {
        ...
        return [
            ...
            head.ros, head.fli, head.flame, head.dist, head.mapdist, head.scorch,
            back.ros, back.fli, back.flame, back.dist, back.mapdist, back.scorch,
            flank.ros, flank.fli, flank.flame, flank.dist, flank.mapdist, flank.scorch,
            beta5.ros, beta5.fli, beta5.flame, beta5.dist, beta5.mapdist, beta5.scorch,
            beta.ros, beta.fli, beta.flame, beta.dist, beta.mapdist, beta.scorch, beta.psi.degrees, beta.psi.ros, beta.theta,
            psi.ros, psi.fli, psi.flame, psi.dist, psi.mapdist, psi.scorch,
