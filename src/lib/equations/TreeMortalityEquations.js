...
export class TreeMortalityEquations {
  // ------------------------------------------------------------------------------
  ...
  */
  static aspenMortality (severity, flameLength, dbh) {
  ...
  static barkThickness (fofem6Code, dbh) {
   ...
   */
  static crownLengthScorched (treeHt, baseHt, scorchHt) {
   ...
   */
  static crownVolumeScorched (treeHt, baseHt, scorchHt) {
    // Tree crown length (ft) and base height (ft)
    const crownLength = treeHt - baseHt
    // Tree crown length scorched (ft)
    const scorchLength = Calc.positive(Math.min(scorchHt, treeHt) - baseHt)
  ...
  static ensureEquationIdx (fofem6Code, equationIdx) {
    if (
      equationIdx < 0 ||
  ...
  static ensureFofem6Code (fofem6Code) {
   ...
   */
  static mortalityRate (fofem6Code, dbh, treeHt, baseHt, scorchHt) {
