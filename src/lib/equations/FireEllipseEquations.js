...
export class FireEllipseEquations {
   ...
   */
  static backingSpreadRate (rosHead, eccent) {
   ...
   */
  static betaSpreadRate (betaHead, rosHead, eccent) {
    let rosBeta = rosHead
   ...
   */
  static flankingSpreadRate (rosMinor) {
    return 0.5 * rosMinor
  }
   ...
   */
  static gSpreadRate (rosMajor, rosBack) {
  ...
  */
   ...
   *  (in the same velocity units-of-measure as spreadRateAtHead).
   */
  static majorSpreadRate (rosHead, rosBack) {
   ...
   */
  static minorSpreadRate (rosMajor, lwr) {
