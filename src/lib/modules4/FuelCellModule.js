...
export class FuelCellModule extends DagModule {
    ...
    constructor(parentMod, parentProp, fuelModelMod, configs) {
        ...
        this.qig    = new DagNode(this, 'qig', U.fuelQig, 'heat of pre-ignition')
        this.beta   = new DagNode(this, 'beta', U.ratio, 'packing ratio')
        this.bopt   = new DagNode(this, 'bopt', U.ratio, 'optimum packing ratio')
        this.brat   = new DagNode(this, 'brat', U.ratio, 'beta-to-optimum ratio')
