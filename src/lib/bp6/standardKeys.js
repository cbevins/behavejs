...
export const phie = 'spread rate effective wind coefficient'
export const phis = 'spread rate slope coefficient'
export const qig  = 'heat of pre-ignition'
export const phiw = 'spread rate wind coefficient'
export const ros  = 'spread rate'
export const rosa = 'spread rate with effective wind speed limit applied'
...
export const scor = 'scorch height'
...
export const waf  = 'wind speed adjustment factor'
export const wndb = 'wind/B'
export const wndc = 'wind/C'
export const wnde = 'wind/E'
export const wndk = 'wind/K'
export const wndi = 'wind/I'
export const wmid = 'midflame wind speed'
export const weff = 'effective wind speed'
export const weffl= 'effective wind speed limit'
export const diam = 'cylindrical diameter'
export const leng = 'cylindrical length'
export const type = 'type'
export const life = 'life'
export const lwr  = 'length-to-width ratio'
export const fli  = 'fireline intensity'
export const flen = 'flame length'
...
export const _fli  = 'fire/fieline intensity'   // ft
export const _flen = 'fire/flame length'        // ft
...
export const _owaf = 'fuel/wind/factor'              // ratio
...
export const _scor = 'fire/scorch height'             // ft
